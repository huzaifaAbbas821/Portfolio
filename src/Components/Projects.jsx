    ...
    let users = [
        {
            ...
            img: bg2,
            paragraph:
                "Created a responsive blog site using React, TailwindCSS, and Redux for seamless UI and state management. Powered by Appwrite, the backend handles authentication, data storage, and real-time features. Includes post creation, editing, and commenting, showcasing full-stack development skills.",
        ...
        },
        {
            title: "Web scrapper",
            img: bg,
            paragraph: `Developed a web scraper using Puppeteer to extract data from
            Amazon pages and store it in JSON files. Designed a system to parse
            and display the scraped data on a web page, enabling users to view
            and interact with the information in an organized format.`,
        ...
        },
        {
            title: "Todo App",
            img: bg1,
            paragraph: `Developed a simple todo app with a frontend built using React,
            utilizing state management to handle task data. Tasks are stored in
            local storage for persistent data management, and users can add,
            edit, and delete tasks efficiently.`,
    ...
    return (
        <div className="mt-[5vh] w-full bg-zinc-900 px-2 py-20 text-white md:px-[2vw] lg:px-[2vw]">
            ...
            <Element name="projects">
                <div
                    id="projects"
                    className="mt-[4vw] flex w-full flex-col items-center justify-center"
                >
                    <div className="flex w-[100%] flex-col items-center justify-center text-wrap">
                        ...
                        <p className="isolate my-4 mt-4 block w-[93%] text-wrap px-2 text-justify text-[3vh] font-normal text-white md:text-center lg:mt-[2vw] lg:text-[1.6vw]">
                            Here you will find some of my personal projects that
                            I created on the journey of my learning web
                            development. You will also get a link of my sites
                    ...
                    >
                        <div className="mt-3 flex w-full flex-col gap-8 md:mt-4 md:items-center md:justify-center lg:flex-row">
                            ...
                            <div className="flex w-full flex-col lg:mt-[2vw] lg:w-1/2">
                                <h1 className="px-2 text-left text-[6vh] font-semibold text-[#45b5d4] md:text-center md:text-3xl lg:w-[100%] lg:text-justify lg:text-[3vw]">
                                    {user.title}
                                </h1>
                                <div className="mt-2 flex w-full items-center justify-between rounded-[20px] text-white md:mt-7 md:w-[100%] md:justify-center md:px-[4vw] lg:mt-[1vw] lg:px-[0vw]">
                                    <p className="isolate mx-2 my-4 mt-4 block w-[100%] text-wrap text-justify text-[3vh] font-normal tracking-tight text-white md:font-medium md:leading-8 lg:mx-0 lg:mt-0 lg:px-0 lg:text-[1.6vw] lg:leading-[2vw]">
                                        {user.paragraph}
                                    </p>
                                </div>
